...
function add_help_tabs_to_db(){
        ...
        $wpdb->insert( wp_editable_help_tabs, array( 'title_tab' =>  $title_tab, 'text_tab' => $text_tab, 'text_sidebar' => '',  'tab_status' => $status_tab, 'screen_id' => $current_screen_id) );
...
function editing_existed_help_tabs_from_db (){
    ...
    $wpdb->update( wp_editable_help_tabs, array( 'title_tab' =>  $title_tab, 'text_tab' => $text_tab, 'text_sidebar' => '',  'tab_status' => $status_tab), array( 'id_tab' => $current_tab_id ) );
};
//================ Edit data in DB ==================================
...
//    var_dump($status_trash);
    if($status_trash == "trash"){
        echo '<p class="to-publish"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
